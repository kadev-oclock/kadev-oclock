...
<p align="center">
  <img src="https://readme-typing-svg.herokuapp.com?font=Fira+Code&pause=1000&color=F75C7E&center=true&vCenter=true&width=435&lines=D%C3%A9veloppeur+FullStack;Sp%C3%A9cialis%C3%A9+en+React+%26+Symfony;Passionn%C3%A9+par+le+code+propre" alt="Typing SVG" />
</p>
...
Développeur FullStack passionné avec un parcours unique : **20 ans d'expérience en tant que technicien coloriste** dans l'industrie pharmaceutique, reconverti dans le développement web.

🎓 **Formation**
- 🎖️ Concepteur Développeur d'Applications Niveau 6 (O'clock)
- 🎓 Bachelor Chef de Projet Digital
- 📜 Certification OPQUAST
- 🎨 Certification Bac+2 Maquettiste Infographiste

💼 **Actuellement**
- 🔭 Je travaille sur [facture-app](https://github.com/kadev-oclock/facture-app)
- 🌱 J'apprends **Next.js**, **TDD** et j'approfondis **React**
- 🚀 En transition vers l'administration système (formation TSSR prévue)
- 💡 Intéressé par les architectures clean et les bonnes pratiques
...
```javascript
const currentGoals = {
  frontend: ['Next.js', 'React avancé', 'TypeScript avancé'],
  backend: ['Symfony avancé', 'Architecture hexagonale'],
  devops: ['Kubernetes', 'CI/CD avancé'],
  methodology: ['TDD', 'DDD'],
  certification: ['TSSR - Technicien Supérieur Systèmes et Réseaux']
};
```
...
<p align="center">
  <i>⭐️ N'hésitez pas à explorer mes repos et à laisser une étoile si quelque chose vous intéresse !</i>
</p>
